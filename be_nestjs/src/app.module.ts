...
@Module({
  imports: [
    ...
    StudenteModule,
    //----------------   connection MONGODB ($ npm i @nestjs/mongoose mongoose) -----------------
    MongooseModule.forRoot('mongodb+srv://srv-staging-etable:tMzY8eD7YiHSdAKD@etable-cl.ftxyywv.mongodb.net/etable-staging?retryWrites=true&w=majority'),
